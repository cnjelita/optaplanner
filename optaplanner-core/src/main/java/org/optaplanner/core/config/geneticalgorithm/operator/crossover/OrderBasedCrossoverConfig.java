...
import org.optaplanner.core.impl.geneticalgorithm.operator.crossover.OrderBasedCrossover;

@XStreamAlias("orderBasedCrossoverOperator")
public class OrderBasedCrossoverConfig extends ChainingCrossoverOperatorConfig {
